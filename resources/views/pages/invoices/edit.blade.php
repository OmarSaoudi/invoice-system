                ...
                <div class="row">
                   <div class="col-md-4">
                      <div class="form-group">
                         ...
                         <input type="text" name="invoice_number" value="{{ $invoices->invoice_number }}" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                         ...
                         <select id="product_id" name="product_id" class="form-control">
                             <option value="{{ $invoices->product->name }}"> {{ $invoices->product->name }}</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-md-4">
